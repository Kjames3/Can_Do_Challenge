...
# YOLO Model - can use larger model with GPU
YOLO_MODEL = 'yolov8s.pt'   # Small model (GPU can handle this)
# Alternative: 'yolov8s.engine' for TensorRT (even faster, requires export)
